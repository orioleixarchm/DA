...
gdown.download(urls[0], 'interventions.xlsx', quiet=False)
gdown.download(urls[1], 'ambulances.xlsx', quiet=False)
gdown.download(urls[2], 'aed.xlsx', quiet=False)
interventions = pd.read_excel(f'interventions.xlsx')
